...
class Options extends Component {
    ...
    renderLicenseSettings() {
        return [
            (<TextField
                placeholder={I18n.t('Place your ioBroker.consumption license here')}
            ...
            (<br/>),
            !this.props.native.license ? (<p key="hint">{I18n.t('license_hint')} <a href="https://iobroker.net/accountLicenses" rel="noopener noreferrer" target="_blank">iobroker.net</a></p>) : null,
            (<br/>),
